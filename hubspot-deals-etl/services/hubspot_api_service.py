...
class APIService:
    ...
    def get_data(self, 
        ...
        try:
            ...
            params = {
                ...
                'properties': 'dealname,dealstage,pipeline,amount,deal_currency_code,closedate,createdate,hs_lastmodifieddate,hs_is_closed,hs_is_closed_won,hs_deal_stage_probability,hubspot_owner_id,dealtype,description',
            }
    ...
    def validate_token(self, access_token: str) -> bool:
        ...
        try:
            ...
            # HubSpot token validation — fetch 1 deal to confirm access
            url = f"{self.base_url}/crm/v3/objects/deals"
            params = {'limit': 1}
    ...
    def get_api_usage(self, auth_config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # HubSpot rate limit headers endpoint
            url = f"{self.base_url}/crm/v3/objects/deals"
            params = {'limit': 1}
            ...
            if response.status_code == 200:
                ...
                usage_info = {
                    ...
                    'interval_limit': response.headers.get('X-HubSpot-RateLimit-Interval-Max'),
                    'interval_remaining': response.headers.get('X-HubSpot-RateLimit-Remaining'),
                    'reset_timestamp': response.headers.get('X-HubSpot-RateLimit-Reset'),
